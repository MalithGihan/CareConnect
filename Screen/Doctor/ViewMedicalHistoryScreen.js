...
import { fetchAppointment } from '../../utils/actions/userActions';

export default function ViewMedicalHistoryScreen({ route }) {
    const [appointments, setAppointments] = useState([]);
    const { patientId } = route.params;

    useEffect(() => {
        const fetchData = () => {
            fetchAppointment(patientId, setAppointments);
        };
